...
<body>
    <form method="POST" action="{{route('card.store')}}" enctype="multipart/form-data">
     @csrf
        ...
        <input id="tite" type="text" name="title" >
        <input id="category" type="text" name="category" >
        <input id="Amountunit" type="text" name="Amountunit" >
        <input id="Amount" type="text" name="Amount" >
        <input id="currency" type="text" name="currency" >
        <select id="typeoffer"  name="typeoffer" >

          <option value="douma">douma</option>
          <option value="doeema">doeeuma</option>
        </select>
        <input id="price" type="text" name="price" >
        <input id="exchange" type="text" name="exchange" >
