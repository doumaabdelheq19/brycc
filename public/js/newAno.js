...
function movee($k){
  ...
  var datadoumaa = $('#dpp'+$k+'').html();
  $('#totalzz').val(datadoumaa);
  console.log(datadoumaa);
...
function moveee($k){
  ...
  var datadoumaa = $('#dppk'+$k+'').html();
  $('#totalzzz').val(datadoumaa);
  console.log(datadoumaa);
...
function moveeel($k){
  ...
  var datadoumaa = $('#dppkk'+$k+'').html();
  $('#totalzzzz').val(datadoumaa);
  console.log(datadoumaa);
...
function mover(){
  ...
  var datadoumaaa = $('#title').val();
  $('#titlel').val(datadoumaaa);
  console.log(datadoumaaa);
  var datadoumaaaa = $('#amount').val();
  $('#amountl').val(datadoumaaaa);
  console.log(datadoumaaaa);
  var datadoumaaz = $('#description').val();
  $('#descriptionl').val(datadoumaaz);
  console.log(datadoumaaz);
}
...
function movel(){
  ...
  var datadoumaaa = $('#price').val();
  $('#pricel').val(datadoumaaa);
  console.log(datadoumaaa);
  var datadoumaaaa = $('#currency').val();
  $('#currencyl').val(datadoumaaaa);
  console.log(datadoumaaaa);
...
function movll(){
  ...
  var datadoumaaa = $('#country').val();
  $('#countryl').val(datadoumaaa);
  console.log(datadoumaaa);
  var datadoumaaaa = $('#city').val();
  $('#cityl').val(datadoumaaaa);
  console.log(datadoumaaaa);
  var datadoumaaaaz = $('#region').val();
  $('#regionl').val(datadoumaaaaz);
  console.log(datadoumaaaaz);
