        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
          <tr>
            <td align="center" valign="top" style="padding: 36px 24px;">
                <a href="<?php echo e(url('')); ?>"><img style="width:250px" src="./Imeges/Brecycler2 Chosen-02 (1).png" alt="" /></a>
            </td>
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
          ...
          <tr>
            <td align="left" bgcolor="#ffffff" style="padding: 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;">
              ...
              <p style="margin: 0;"> <form method="POST" action="<?php echo e(route('logout')); ?>">
                <?php echo csrf_field(); ?>
...
</html><?php /**PATH C:\xampp\htdocs\final-project\resources\views/auth/verify-email.blade.php ENDPATH**/ ?>