...
<?php unset($__componentOriginal71c6471fa76ce19017edc287b6f4508c); ?>
<?php endif; ?>
                    <a class="ml-3" href="<?php echo e(route('card.create')); ?>"  >
                        create card
                    </a>
                    <a class="ml-3" href="<?php echo e(route('artcile.create')); ?>"  >
                        create article
                    </a>
                </div>
            </div>
...
<?php /**PATH C:\xampp\htdocs\final-project\resources\views/layouts/navigation.blade.php ENDPATH**/ ?>