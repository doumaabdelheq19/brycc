...
<head>
  ...
  <link
    ...
    rel="stylesheet" />
  <title><?php echo e($course_id); ?></title>
    ...
    <div class="container">
      ...
      <div class="contr">
        ...
        <?php $__currentLoopData = $cods; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cod): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          <a class="box" href="<?php echo e(url('papca' , $cod->id)); ?>">
            <div class="image">
...
<?php /**PATH C:\xampp\htdocs\final-project\resources\views/categories/papaer.blade.php ENDPATH**/ ?>