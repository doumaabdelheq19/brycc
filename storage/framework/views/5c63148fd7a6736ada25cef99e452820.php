...
<body>
     ...
     <div class="container">
        ...
        <form method="POST" action="<?php echo e(route('login')); ?>" onsubmit="return handleFormSubmit()>
          <?php echo csrf_field(); ?>
...
<?php endif; ?>
      ...
      <script>
        ...
        // If validation fails, capture the errors and display them
        let errors = {
            email: ['The email address is required.'],
            password: ['The password is required.'],
        };
        displayErrors(errors); // Call the displayErrors function
        return false; // Prevent form submission
    }
    </script>
</body>
</html><?php /**PATH C:\xampp\htdocs\final-project\resources\views/auth/custom-login.blade.php ENDPATH**/ ?>